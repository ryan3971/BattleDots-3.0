...
public class shootLaser {
    ...
    public shootLaser(Canvas canvasParameter, ManageObjects manageObjects, OtherManageObjects otherManageObjects)     {
    ...
    public void checkLaserLocation(int list_num)     {
        ...
        if (laser_y_coordinates < top || laser_y_coordinates > bottom
            ...
            if (MANAGE_OBJECTS_OBJECT != null)
                ...
                OTHER_MANAGE_OBJECTS_OBJECT.removeLaserFromList(list_num);   //Gives the go ahead for laser to be remove from the list
